        ...
        <>
            <header className={styles.header} role="banner">
                <div className={styles.headerInner}>
                    {/* Logo */}
                    <Link href="/" className={styles.logo} aria-label="Matjar Groceries - Home">
                        <div className={styles.logoIcon}>
                            <span className="material-symbols-outlined" aria-hidden="true">eco</span>
                        </div>
                        <h1 className={styles.logoText}>
                            Matjar <span className={styles.logoAccent}>Groceries</span>
                        </h1>
                    </Link>
                    ...
                    <div className={styles.searchBar} role="search">
                        ...
                        >
                            <input
                                ...
                                placeholder="Search produce, meat, dairy..."

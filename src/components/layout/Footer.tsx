        ...
        <footer className={styles.footer}>
            <div className={styles.footerInner}>
                <div className={styles.footerBrand}>
                    ...
                    <span className={styles.footerLogoText}>Matjar Groceries</span>
                </div>
                ...
                {canInstall && !installed && (
                    <div className={styles.installSection}>
                        <div className={styles.installInfo}>
                            ...
                            <span className={styles.installText}>Install app for quick access</span>
                        </div>
                ...
                <p className={styles.footerCopy}>
                    © 2026 Matjar Groceries. Fresh from farm to your table.
                </p>
            </div>
        </footer>
    );

...
/**
 * OSRM — calculate road travel distance (km)
 * Free, no API key needed. Profile 'car' = road route
    ...
    useEffect(() => {
        ...
        import('leaflet').then((L) => {
            ...
            L.circleMarker([storeLat, storeLng], {
                ...
                .addTo(map)
                .bindPopup('\ud83d\udccd Matjar Groceries Store');
        ...
        <div className={styles.mapWrapper}>
            ...
            {!loading && selectedLocation && !tooFar && (
                <div className={styles.mapInfo}>
                    ...
                    <span>{selectedLocation.jarak} km from store</span>
                </div>
            )}
            ...
            {!loading && tooFar && (
                <div className={`${styles.mapInfo} ${styles.mapInfoError}`}>
                    ...
                    <span>Location too far ({selectedLocation?.jarak} km). Max {maxJarak} km.</span>
                </div>
            )}
            ...
            {!loading && !selectedLocation && (
                <div className={`${styles.mapInfo} ${styles.mapInfoHint}`}>
                    ...
                    <span>Tap map to select delivery location</span>
                </div>
            )}
        </div>
    );

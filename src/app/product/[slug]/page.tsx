...
export async function generateMetadata({
    ...
    if (!product) return { title: 'Product Tidak Found' };
        ...
        '@graph': [
            {
                ...
                offers: {
                    ...
                    seller: { '@type': 'Organization', name: 'Matjar Groceries' },
                },
            ...
            },
            {
                '@type': 'BreadcrumbList',
                itemListElement: [
                    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://matjargroceries.com' },
                    { '@type': 'ListItem', position: 2, name: product.kategori_nama || 'Product', item: `https://matjargroceries.com/categories/${product.kategori_nama?.toLowerCase().replace(/\s+/g, '-') || 'all'}` },
        ...
        <>
            ...
            <main className={styles.page}>
                ...
                <nav className={styles.breadcrumb} aria-label="Breadcrumb">
                    ...
                    <Link href={`/categories/${product.kategori_nama?.toLowerCase().replace(/\s+/g, '-') || 'all'}`} className={styles.breadcrumbLink}>
                        {product.kategori_nama || 'Product'}
                    </Link>
                    <span className="material-symbols-outlined" style={{ fontSize: '14px' }}>chevron_right</span>
                        ...
                        {allRelated.map((p) => (
                            ...
                            >
                                ...
                                <div className={styles.relatedCardBottom}>
                                    ...
                                    <button className={styles.relatedAddBtn} aria-label={`Add ${p.nama}`}>

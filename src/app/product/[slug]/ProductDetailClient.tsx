        ...
        <>
            ...
            {variasi && variasi.opsi.length > 0 && (
                <div className={styles.variantSection}>
                    <label className={styles.variantLabel}>Select {variasi.nama || 'Size'}</label>
            ...
            <div className={styles.notesSection}>
                ...
                <textarea
                    ...
                    placeholder="e.g. Please pick small leaves..."
                    rows={2}
                    value={catatan}
            ...
            <div className={styles.cartActions}>
                ...
                <button className={styles.addToCartBtn} onClick={handleAdd}>
                    ...
                    {added ? 'Ditambahkan!' : `Add — ${formatHarga(hargaFinal * qty)}`}
                </button>
            </div>
            ...
            <button className={styles.shareBtn} onClick={handleShare}>
                ...
                {shared ? 'Link Tersalin!' : 'Bagikan Product'}
            </button>
        </>
    );
}
